...
public class FlightTicketBooking extends javax.swing.JFrame {
     ...
     */
    int adult,children;
    String currency,persontype,trip;
    ...
    public void initComponents() {
        ...
        // JTabbedPane jTabbedPane10 = new JTabbedPane();
        // jTabbedPane10.addTab("close", close);
        ...
        jTextField4.setText("e.g. 395783");
...
//        jTabbedPane3.addTab("⚙ Manage Flights", jPanel5);
        ...
        Home.setBounds(5,400,200,50);
        Color clr=new Color(255,163,0);
        Home.setBackground(clr);

        Home1.setBounds(5,400,200,50);

        Home1.setBackground(clr);

        Home2.setBounds(5,420,200,50);

        Home2.setBackground(clr);

        Home3.setBounds(5,400,200,50);

        Home3.setBackground(clr);

        // back.setBounds(420,0,70,20);
        jPanel2.add(Home);
        jPanel3.add(Home1);
//        jPanel4.add(Home2);
//        jPanel5.add(Home3);
...
//        pb.setVisible(true);
        try{
            ...
            int i=0;
            while(rs.next()){
                if(rs.getString(12).equals(jTextField4.getText())){
                    if(rs.getString(1).equals(jTextField3.getText())){
                        chk2=true;
                    }
                    else{
                        chk2=false;
            ...
            if(chk){
                check_in ci=new check_in(jTextField4.getText());
                ci.setVisible(true);
            }
            else{
                if(i==0){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        //FlightTicketBooking mfb=new FlightTicketBooking();
//        adult=Integer.parseInt((String) jComboBox7.getSelectedItem());
//        children=Integer.parseInt((String) jComboBox8.getSelectedItem());
//        currency=(String)jComboBox9.getSelectedItem();
        if (jTextField1.getText().equals("From") || jTextField1.getText().isBlank()){
            JOptionPane.showMessageDialog(this,"Please, Enter valid Place for from address");
        }
        else if (jTextField2.getText().equals("To") || jTextField2.getText().isBlank()){
            JOptionPane.showMessageDialog(this,"Please, Enter valid Place for to address");
        }
        else if ("01".equals(jComboBox1.getSelectedItem()) && "01".equals(jComboBox2.getSelectedItem()) && "2023".equals((String)jComboBox3.getSelectedItem())){
            JOptionPane.showMessageDialog(this,"Enter valid departure date");
        }
        else if(trip==null){
            JOptionPane.showMessageDialog(this,"Enter one way or round trip");
        }
        //int na=Integer.parseInt((String)jComboBox7.getSelectedItem());
        else if(jComboBox7.getSelectedItem().equals("0")){
            JOptionPane.showMessageDialog(this,"Adult cannot be 0 ");
        }
        else{
            ProgressBar pb=new ProgressBar(this);
            pb.setVisible(true);
    ...
    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {
        // TODO add your handling code here:
        if(jTextField4.getText().equalsIgnoreCase("e.g. 395783")){
            jTextField4.setText("");
        }
    }
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        trip=jRadioButton2.getText();
    }
    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        persontype=jRadioButton3.getText();
    }
    private void jRadioButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        persontype=jRadioButton4.getText();
    }
    private void jRadioButton5ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        persontype=jRadioButton5.getText();
    }
    private void jRadioButton6ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        persontype=jRadioButton6.getText();
    }
    private void jRadioButton7ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        persontype=jRadioButton7.getText();
    }
    private void jRadioButton8ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        persontype=jRadioButton8.getText();
    }
